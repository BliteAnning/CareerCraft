        ...
        <div className="flex flex-col items-center mx-4 mt-10 sm:mt-20">
            ...
            <div className="flex gap-3 bg-purple-700 flex-col sm:mt-16 sm:flex-row">
                <div className="sm:w-1/2  p-5">
                    <img src={student1} alt="" className="object-cover rounded-xl  w-full h-full" />
                </div>
                <div className="mt-20 text-white ">
                    <h1 className="font-extrabold ">Lost in which career to choose? We can help</h1>
                    <div className="border-2 mt-3.5 p-3 hover:cursor-pointer hover:border-white transition-all ease-in-out duration-500  rounded-xl border-purple-400">Start the questionnaire </div>
                    <div className="border-2 mt-3.5 p-3 hover:cursor-pointer hover:border-white transition-all ease-in-out duration-500  rounded-xl border-purple-400">Take a quiz about your career</div>
                    <div className="border-2 mt-3.5 p-3 hover:cursor-pointer hover:border-white transition-all ease-in-out duration-500  rounded-xl border-purple-400">Explore Resources in the library</div>
                    <div className="border-2 mt-3.5 p-3 hover:cursor-pointer hover:border-white transition-all ease-in-out duration-500  rounded-xl border-purple-400">Get a free resume Assessment</div>
                    
                </div>
            </div>
            {/*Audience section*/}
            <div className="sm:mt-16 flex flex-col mx-4">
                <h1 className="font-extrabold text-5xl items-center justify-center flex">Who can Use CareerCraft?</h1>
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 m-10">
                    <div className="sm:flex-row flex flex-col gap-2 border-black rounded-xl shadow-2xl">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-2">Parents can take the test for their kids who are yet to start the elementary school</p>
                        </div>
                    </div>
                    <div className="sm:flex-row flex flex-col gap-2 border-black rounded-xl shadow-2xl">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-2">Students who are in middle and High school and are stuck which career they should pursue and how to do that,
                    ...
                    <div className="sm:flex-row flex flex-col gap-2 border-black rounded-xl shadow-2xl">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-2">College Graduates who are still trying to figure out what they want to do even after college?
                    ...
                    <div className="sm:flex-row flex flex-col gap-2 border-black rounded-xl shadow-2xl">
                        ...
                        <div className="p-4">
                            ...
                            <p className="mt-2">Not for only students but also for workers who wants to further up their career or take a different
            ...
            <div className="flex flex-col sm:flex-row min-h-96 mt-20">
                ...
                <div className="flex justify-center items-center w-full sm:w-1/2 text-white px-5 bg-gray-900">
